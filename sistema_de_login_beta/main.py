...
def chama_segunda_tela():
    ...
    try:
        banco = sqlite3.connect(r'./banco/banco_cadastro.db') 
        curso= banco.cursor()
...
primeira_tela=uic.loadUi(r"./tela/login.ui")
segunda_tela = uic.loadUi(r"./tela/bem-vindo.ui")
tela_cadastro = uic.loadUi(r"./tela/cadastro.ui")
